...
/// カテゴリ別学習画面
class CategoryStudyScreen extends StatefulWidget {
  final LicenseType licenseType;
  final String? category;

  const CategoryStudyScreen({
    super.key,
  ...
  @override
  State<CategoryStudyScreen> createState() => _CategoryStudyScreenState();
}

class _CategoryStudyScreenState extends State<CategoryStudyScreen> {
  @override
  void initState() {
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (widget.category != null) {
        context.read<QuizProvider>().loadCategoryQuestions(
              widget.licenseType,
              widget.category!,
            );
      } else {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.category ?? 'カテゴリ別学習'),
  ...
  Widget _buildBody(QuizProvider quizProvider) {
    // MultipleChoiceScreenと同じロジックを使用
